...
<section style="padding:80px 24px;text-align:center;background:#f9fafb;">
    <div style="max-width:720px;margin:0 auto;">
        ...
        <a href="#" style="display:inline-flex;align-items:center;gap:8px;padding:14px 32px;font-size:.9375rem;font-weight:600;border-radius:8px;text-decoration:none;background:#111827;color:#fff;">Get started</a>
    </div>
</section>
HTML)
            ->schema(fn () => [

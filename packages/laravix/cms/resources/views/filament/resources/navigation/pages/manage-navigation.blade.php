<x-filament-panels::page>
    ...
    <div x-data="{ tab: 'items' }">
        ...
        <div class="flex gap-1 mb-6 border-b border-gray-200 dark:border-gray-700">
            ...
            >
                {{ __('laravix::navigation.tabs.items') }}
            </button>
            <button
                type="button"
                @click="tab = 'design'"
                ...
                class="px-4 py-2.5 text-sm font-medium transition-colors -mb-px"
            >
                {{ __('laravix::navigation.tabs.design') }}
            </button>
        </div>

        <div x-show="tab === 'items'" x-cloak>

            @include('laravix::filament.resources.navigation.partials.preview-frame', [
                'label' => __('laravix::navigation.labels.header'),
                'part'  => 'header',
            ])
            ...
            <div class="mt-8">
                @include('laravix::filament.resources.navigation.partials.preview-frame', [
                    'label' => __('laravix::navigation.labels.footer'),
                    'part'  => 'footer',
                ])
            </div>
